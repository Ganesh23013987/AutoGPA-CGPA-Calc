...
# ---------------- PAGE CONFIG ----------------
st.set_page_config(page_title="AutoGPA Multi-Sem", layout="wide")
...
if uploaded_file:
    ...
    if subjects:
        ...
        tab1, tab2, tab3 = st.tabs(["📊 Subjects & KPI", "📈 Graph", "🧮 Calculation"])
        ...
        with tab3:
            ...
            if st.button("📥 Download GPA & CGPA Report"):
                ...
                elements.append(Paragraph("<b>AutoGPA Academic Report</b>", styles["Title"]))
                elements.append(Spacer(1, 0.3 * inch))

                # Subject Table
                data = [["Subject", "Credits", "Grade", "Grade Point", "Weighted"]] + \
                       df_final[["Subject", "Credits", "Grade", "Grade Point", "Weighted"]].values.tolist()
                ...
                # GPA Calculation
                elements.append(Paragraph("<b>GPA Calculation</b>", styles["Heading2"]))
                elements.append(Paragraph(
                    f"GPA = {current_weighted} / {current_credits} = {current_gpa}",
                    styles["Normal"]
                ))
                elements.append(Spacer(1, 0.3 * inch))

                # CGPA Calculation
                elements.append(Paragraph("<b>CGPA Calculation</b>", styles["Heading2"]))
                elements.append(Paragraph(
                    f"CGPA = {total_all_weighted} / {total_all_credits} = {final_cgpa}",
                    styles["Normal"]
                ))
...
© 2025 AutoGPA-CGPA Calculator | Developed by Ganesh D
</p>
""", unsafe_allow_html=True)        